                ...
                <div className="col-xl-3 col-md-6 col-grid-box">
                    <div className="product-box">
                        <div className="img-wrapper">
                            <div className="front">
                                <Link to={`${FASHION_SINGLE_PRODUCT_ROUTE}/${product.id}`} ><img
                        ...
                        <div className="product-detail">
                            <div>
                                ...
                                {/*<div className="rating">*/}
                                    {/*{RatingStars}*/}
                                {/*</div>*/}
                                <Link to={`${FASHION_SINGLE_PRODUCT_ROUTE}/${product.id}`}>
                                    <h6>{product.name}</h6>
                                </Link>
                                            ...
                                            <div className="col-lg-6 rtl-text">
                                                <div className="product-right">
                                                    ...
                                                    <div className="product-buttons">
                                                        ...
                                                        <Link to={`${FASHION_SINGLE_PRODUCT_ROUTE}/${product.id}`} className="btn btn-solid">view detail</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
