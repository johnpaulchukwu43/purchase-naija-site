...
class Compare extends Component {
    ...
    render (){
        ...
        const {Items, symbol, addToCart, removeFromCompare,cartInfo} = this.props;
                                        ...
                                        <div key={index}>
                                            <div className="compare-part">
                                                ...
                                                <div className="img-secton">
                                                    ...
                                                    <img src={`${item.imageUrls[0]}`} className="img-fluid" alt="" />
                                                ...
                                                <div className="btn-part">
                                                    <a href="javascript:void(0)" className="btn btn-solid" onClick={() => addToCart(cartInfo,item, 1)}>add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    )}
...
export default connect(
    mapStateToProps,
    {removeFromCompare, addToCart:addToCartWithoutSpecifyingQuantity}
)(Compare)
